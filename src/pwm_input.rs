...
/// ```
/// use stm32f2xx_hal::pac::TIM8;
/// use stm32f2xx_hal::timer::Timer;
/// use stm32f2xx_hal::pwm_input::PwmInput;
/// use stm32f2xx_hal::gpio::gpioc::PC6;
/// use stm32f2xx_hal::gpio::Alternate;
///
